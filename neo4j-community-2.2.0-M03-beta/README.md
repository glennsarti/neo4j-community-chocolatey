...
```powershell
choco install neo4j-community -version 2.2.0-M03-beta -prerelease
```
...
Example usage;
```powershell
choco install neo4j-community -version 2.2.0-M03-beta -prerelease -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

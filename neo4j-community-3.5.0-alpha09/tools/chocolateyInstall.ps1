...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.5.0-alpha09-windows.zip'
$md5Checksum = '7e9664f37816cf1dab704891025bad56'
$neozipSubdir = 'neo4j-community-3.5.0-alpha09'

...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.3.3-windows.zip'
$md5Checksum = 'a9e9ee06c5e9ab324a07582e253f4ed9'
$neozipSubdir = 'neo4j-community-3.3.3'

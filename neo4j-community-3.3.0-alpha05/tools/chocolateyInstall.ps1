...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.3.0-alpha05-windows.zip'
$md5Checksum = '66a806c16971b6f0eab11611dd2ca34b'
$neozipSubdir = 'neo4j-community-3.3.0-alpha05'

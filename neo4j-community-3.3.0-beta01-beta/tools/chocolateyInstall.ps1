...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.3.0-beta01-windows.zip'
$md5Checksum = '43397afc9d6fac99bb2db7a9a6c53be2'
$neozipSubdir = 'neo4j-community-3.3.0-beta01'

...
2. Install OpenJDK 7/8 or Oracle Java 7/8 http://neo4j.com/docs/stable/deployment-requirements.html#_software
3. Install this package
```powershell
choco install neo4j-community -version 2.2.2.20150617
```
...
Example usage;
```powershell
choco install neo4j-community -version 2.2.2.20150617 -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.2.4-windows.zip'
$md5Checksum = '058a87af060ade05ee3dcdbb8b71918c'
$neozipSubdir = 'neo4j-community-3.2.4'

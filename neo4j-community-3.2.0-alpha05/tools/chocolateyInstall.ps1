...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.2.0-alpha05-windows.zip'
$md5Checksum = 'aab159095d59c44c2eb141048fe613c8'
$neozipSubdir = 'neo4j-community-3.2.0-alpha05'

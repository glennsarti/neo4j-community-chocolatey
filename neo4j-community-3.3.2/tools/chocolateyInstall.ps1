...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.3.2-windows.zip'
$md5Checksum = 'a027780ec187ae21184341277f0a5e11'
$neozipSubdir = 'neo4j-community-3.3.2'

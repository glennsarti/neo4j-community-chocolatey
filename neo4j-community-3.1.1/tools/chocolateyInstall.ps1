...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.1.1-windows.zip'
$md5Checksum = '290a82142c91e853c70885cc3247bab4'
$neozipSubdir = 'neo4j-community-3.1.1'

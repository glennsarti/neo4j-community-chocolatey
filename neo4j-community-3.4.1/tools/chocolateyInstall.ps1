...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.4.1-windows.zip'
$md5Checksum = '74affc984dffe92f4bbf258bf8583abd'
$neozipSubdir = 'neo4j-community-3.4.1'

...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.2.0-alpha04-windows.zip'
$md5Checksum = '80975603f540c09a07b4c987faf22933'
$neozipSubdir = 'neo4j-community-3.2.0-alpha04'

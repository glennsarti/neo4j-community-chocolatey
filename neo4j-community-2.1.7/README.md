...
```powershell
choco install neo4j-community -version 2.1.7.20150617
```
...
Example usage;
```powershell
choco install neo4j-community -version 2.1.7.20150617 -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

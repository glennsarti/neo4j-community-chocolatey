...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.4.6-windows.zip'
$md5Checksum = '0ccb379a6a1eceacb05cc9a886c2dd0f'
$neozipSubdir = 'neo4j-community-3.4.6'

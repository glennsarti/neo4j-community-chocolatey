$PackageDefinition = @{
  ...
  "DownloadURL" = "http://neo4j.com/artifact.php?name=neo4j-community-3.2.5-windows.zip";
  "MD5Checksum" = "5cd2b1719ecf2a2577ee92bd4ebcad3b";
  "NeoZipSubdir" = "neo4j-community-3.2.5";
  "NeoServerApiJarSuffix" = "3.2.5";

$PackageDefinition = @{
  ...
  "DownloadURL" = "http://neo4j.com/artifact.php?name=neo4j-community-3.3.4-windows.zip";
  "MD5Checksum" = "5b4345ccc4ec9e2bf0bc8775ac1fb553";
  "NeoZipSubdir" = "neo4j-community-3.3.4";
  "NeoServerApiJarSuffix" = "3.3.4";

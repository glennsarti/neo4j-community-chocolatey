...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.2.2-windows.zip'
$md5Checksum = 'c8df84952fd645c1bc602b1711e69ecb'
$neozipSubdir = 'neo4j-community-3.2.2'

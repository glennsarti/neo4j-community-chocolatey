...
```powershell
choco install neo4j-community -version 3.1.2
```
...
Example usage;
``` powershell
choco install neo4j-community -version 3.1.2 -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.1.2-windows.zip'
$md5Checksum = '2848d482bd83dfd40aff1dd4e91325d7'
$neozipSubdir = 'neo4j-community-3.1.2'

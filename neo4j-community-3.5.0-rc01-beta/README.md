...
```powershell
choco install neo4j-community -version 3.5.0-rc01-beta -prerelease
```
...
Example usage;
``` powershell
choco install neo4j-community -version 3.5.0-rc01-beta -prerelease -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

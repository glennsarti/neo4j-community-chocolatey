...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.4.10-windows.zip'
$md5Checksum = '317e20ae610c222f60c5ab3e24d8af9f'
$neozipSubdir = 'neo4j-community-3.4.10'

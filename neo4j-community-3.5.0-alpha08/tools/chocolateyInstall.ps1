...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.5.0-alpha08-windows.zip'
$md5Checksum = 'c05656695df9021f011d5615d3182932'
$neozipSubdir = 'neo4j-community-3.5.0-alpha08'

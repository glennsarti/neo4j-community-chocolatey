...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.3.0-beta02-windows.zip'
$md5Checksum = 'b827ba56253f36d67e4ddaa3cebb8075'
$neozipSubdir = 'neo4j-community-3.3.0-beta02'

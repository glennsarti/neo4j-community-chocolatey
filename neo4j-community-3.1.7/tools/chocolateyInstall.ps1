...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.1.7-windows.zip'
$md5Checksum = '0c1679b2c230550d8bc04493784cd721'
$neozipSubdir = 'neo4j-community-3.1.7'

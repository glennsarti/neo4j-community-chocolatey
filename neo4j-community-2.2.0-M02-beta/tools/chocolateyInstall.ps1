...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-2.2.0-M02-windows.zip'
$md5Checksum = '35b092012243ced95c102b5a3ab47eca'
$neozipSubdir = 'neo4j-community-2.2.0-M02'
$neoServerApiJarSuffix = '2.2.0-M02'

...
```powershell
choco install neo4j-community -version 3.2.0-alpha06 -prerelease
```
...
Example usage;
``` powershell
choco install neo4j-community -version 3.2.0-alpha06 -prerelease -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

...
```powershell
choco install neo4j-community -version 2.3.10
```
...
Example usage;
```powershell
choco install neo4j-community -version 2.3.10 -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

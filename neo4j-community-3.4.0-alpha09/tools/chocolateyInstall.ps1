...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.4.0-alpha09-windows.zip'
$md5Checksum = '4887e2fba005314c4e7487ccd4dec71d'
$neozipSubdir = 'neo4j-community-3.4.0-alpha09'

...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.4.3-windows.zip'
$md5Checksum = '401f01721a88044fc12b21c3b9853e9f'
$neozipSubdir = 'neo4j-community-3.4.3'

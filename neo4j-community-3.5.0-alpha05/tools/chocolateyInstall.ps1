...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.5.0-alpha05-windows.zip'
$md5Checksum = '59f8066e95263c3db327e7a93fc3536f'
$neozipSubdir = 'neo4j-community-3.5.0-alpha05'

...
```powershell
choco install neo4j-community -version 3.4.0-rc02-beta -prerelease
```
...
Example usage;
``` powershell
choco install neo4j-community -version 3.4.0-rc02-beta -prerelease -packageParameters "/Install:C:\Apps\Neo /ImportNeoProperties:C:\Config\MyNeoProperites.txt /ImportNeoServerProperties:C:\Config\MyNeoServerProperites.txt"
```

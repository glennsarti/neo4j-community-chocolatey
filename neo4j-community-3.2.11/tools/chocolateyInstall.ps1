...
$downloadUrl = 'http://neo4j.com/artifact.php?name=neo4j-community-3.2.11-windows.zip'
$md5Checksum = 'b55c25e34fbde2cde041cbb96d5e6c89'
$neozipSubdir = 'neo4j-community-3.2.11'
